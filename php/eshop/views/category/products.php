<div class="products">
    ...
    <div class="list">
        ...
        <a class="product" href="<?= $site_url ?>/product.php?product_id=3">
            <img src="media/product/3/3-1.jpg" />
            <span class="name">HP ProDesk 600 G1 Tower</span>
            <span class="price">17990 Kč</span>
        </a>
        ...
        <a class="product" href="<?= $site_url ?>/product.php?product_id=1">
            <img src="media/product/1/1-1.jpg" />
            <span class="name">Lenovo ThinkPad Yoga 260</span>
            <span class="price">36790 Kč</span>
        </a>
