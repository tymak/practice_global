...
const update=()=>{
 ...
 conversation.forEach(element => {
      ...
      text.innerHTML="";
      document.querySelector("section").appendChild(obal)
      
     
      console.log(element.side);

      if (element.side==="local"){
        text.innerHTML=element.text;
        obrazek.src="unicorn.png";
        obal.className="unicorn";
        obal.appendChild(obrazek);
        obal.appendChild(text); 
        }   	
        else{
          text.innerHTML=element.text;
          obrazek.setAttribute("src", "cleverbot.png");
          obal.className="chatbot";
          obal.appendChild(text);   
          obal.appendChild(obrazek);
        
        }
        console.log(obal.className);  
